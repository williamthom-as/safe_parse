...
Everyone interacting in the SafeParse project’s codebases, issue trackers, chat rooms and mailing lists is expected to follow the [code of conduct](https://github.com/[USERNAME]/safe_parse/blob/master/CODE_OF_CONDUCT.md).
